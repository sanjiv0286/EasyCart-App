...
import 'dart:convert';
import 'dart:io';
import 'package:easymart/Admin/adimin_upload_item.dart';
...
class AdminLoginScreen extends StatefulWidget {
  ...
  @override
  State<AdminLoginScreen> createState() => _AdminAdminLoginScreenState();
}

class _AdminAdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  loginAdminNow() async {
    try {
      // print('Attempting to login admin...');
