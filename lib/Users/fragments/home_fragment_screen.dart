...
import 'package:easymart/Users/cart/cart_list_screen.dart';
import 'package:easymart/Users/item/item_details_screen.dart';
import 'package:easymart/Users/item/search_items.dart';
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (responseBodyOfTrending["success"] == true) {
          for (var eachRecord
              in (responseBodyOfTrending["clothItemsData"] as List)) {
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: const OutlineInputBorder(
            borderSide: BorderSide(
              width: 2,
              color: Color.fromARGB(255, 220, 207, 222),
            ),
          ),
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(2232),
                      // color: Colors.white,
                      color: Colors.black,
                      boxShadow: const [
                        BoxShadow(
